...
![img](/Users/jack/Desktop/md/images/70-20190123203028943.png)
...
![img](/Users/jack/Desktop/md/images/70-20190123230804821.png)

**==想让 newData 取代原来的 data ,对数组而言，容量（capacity）已经变为 8 ；size 在newData中还是 4 ，但数组可以装入更多的元素；==**![img](/Users/jack/Desktop/md/images/70-20190123230853839.png)

​	将数组data的**引用改为指向 新的有8个空间的数组**，与newData的引用相同,指向同样的空间；整个过程封装在函数中，当函数执行完成后，newData 就会失效了；而 data 是整个类的成员变量，和整个类的成员变量是相同的，只要类在使用则data就是有效的；![img](/Users/jack/Desktop/md/images/70-20190123230904146.png)

**==之前的4个空间的数组，因为已经没有引用了，垃圾回收器会将其销毁；数组完成扩容==**

![img](/Users/jack/Desktop/md/images/70-20190123230911188.png)
...
![img](/Users/jack/Desktop/md/images/70-20190124131518511.png)
...
![img](/Users/jack/Desktop/md/images/70-20190124132103936.png)
...
![img](/Users/jack/Desktop/md/images/70-20190124132502059.png)

![img](/Users/jack/Desktop/md/images/70-20190124132517730.png)
...
![img](/Users/jack/Desktop/md/images/70-20190124132707690.png)
...
![img](/Users/jack/Desktop/md/images/70-20190124132733516.png)

**2.删除元素后，先不着急缩小数组容量**

![img](/Users/jack/Desktop/md/images/70-20190124132740344.png)

**3.等到数组长度size缩小到数组容量capacity 的1/4 时**

![img](/Users/jack/Desktop/md/images/70-20190124132739989.png)

**4.缩小数组容量，但也只缩小到原来的一半，仍然预留了一半的数组容量供数组进行 addLast 操作**

![img](/Users/jack/Desktop/md/images/70-20190124132740299.png)
...
![img](/Users/jack/Desktop/md/images/70-20190126164156065.png)

​	**a 移除队列，后面的移动一个单位，size -1;得图**

![img](/Users/jack/Desktop/md/images/70-20190126164202334.png)

​	**但==如果 a移除队列后，后面的不移动，记录目前的队首位置为 front，队尾为 tail,只要维护 front 的指向即可（front++）,不需要所有的元素移动一个单位，即可得到循环队列==这种实现方式。**

![img](/Users/jack/Desktop/md/images/70-20190126164202375.png)

## 3.循环队列

​	**front == tail 		 -----		 队列为空时【起始状态如下图所示】**

![img](/Users/jack/Desktop/md/images/70-20190126164214658.png)

​	**队列进入5个元素后【front不变，tail 右移即可（tail++)】**

![img](/Users/jack/Desktop/md/images/70-20190126164240890.png)

​	**将 a 移除队列，【tail不变，front 右移即可（front++)】其余元素不必移动**

![img](/Users/jack/Desktop/md/images/70-20190126164245218.png)

​	继续加入元素到队列中，==**装满后面的空间，前面还有空着的空间，tail 就会移动到前面 0 的位置【环形结构】**==

![img](/Users/jack/Desktop/md/images/70-20190126164252747.png)
...
![img](/Users/jack/Desktop/md/images/70-20190126164258464.png)
...
![img](/Users/jack/Desktop/md/images/70-20190126185242865.png)

### 链表的结构：

图解：数据存储在 “节点”（Node）中，实际存储在E  e 中，数据与数据之间的链接(对下一个链表的引用)由 next 完成；==最后一个节点 next 存储的为 Null；如果为Null则证明是最后一个节点。==

![img](/Users/jack/Desktop/md/images/70-20190126185258131.png)

### ![image-20190127162624478](/Users/jack/Desktop/md/images/image-20190127162624478.png)

### 数组和链表的比较：

![image-20190127162846543](/Users/jack/Desktop/md/images/image-20190127162846543.png)
...
![img](/Users/jack/Desktop/md/images/70-20190126185339056.png)

### ==在链表头添加元素==:

​	图解（要将 666【即node类对象实例】 加入链表中而不破坏现有的链表结构）

![img](/Users/jack/Desktop/md/images/70-20190126185401900.png)

步骤：1.让 node 的 next 指向现在链表的头，即执行  node.next = head

![img](/Users/jack/Desktop/md/images/70-20190126185432984.png)

​	2. 此时，**666 成为新的链表头，让 head  指向新的 666 节点，即执行  head = node**

![img](/Users/jack/Desktop/md/images/70-20190126185449693.png)
...
![img](/Users/jack/Desktop/md/images/70-20190126185505584.png)

步骤：1.要插入节点 666 ，必须要找到插入666之后，这个节点之前的节点是谁，将其叫做 prev，其初始化和 head 在同一个地方,执行 Node prev = head;    

![img](/Users/jack/Desktop/md/images/70-20190126185517225.png)

步骤2：要找到 666 之前节点 ，因为插入 666 的索引为2【链表中并没有索引这个概念】故之前节点的索引为 1 ，从0开始遍历，遍历到索引为1的位置即可；

![img](/Users/jack/Desktop/md/images/70-20190126185531535.png)

步骤3：将 node 的 next 指向 prev 的下一个元素，即执行 node.next = prev.next

![img](/Users/jack/Desktop/md/images/70-20190126185539887.png)

步骤4：prev 的 next 指向 node, 即执行 node.next = prev.next,成功将 666 插入到链表中

![img](/Users/jack/Desktop/md/images/70-20190126185550481.png)
...
![img](/Users/jack/Desktop/md/images/70-20190126185652189.png)

## 4.从链表中删除元素

有虚拟头结点的链表如图所示：![img](/Users/jack/Desktop/md/images/70-20190127113947860.png)

**想要删除索引为 2 的元素，步骤：**

1.先找到所要删除元素的前一个节点,即为图中的 1

![img](/Users/jack/Desktop/md/images/70-20190127114025246.png)

2.prev 对应节点的 next 就是所要删除的节点，称为 delNode,

![img](/Users/jack/Desktop/md/images/70-20190127113934170.png)

3.将 prev 对应节点的 next 赋值称为要删除的节点 delNode 的 next;即 执行 prev.next = delNode.next,从某种意义上来说，就将索引为 2 的元素从链表中删除了。 

![img](/Users/jack/Desktop/md/images/70-20190127114153369.png)
...
![img](/Users/jack/Desktop/md/images/70-20190127114235855.png)

## 6.使用链表实现栈

==将链表头当做栈顶，用链表作为栈的底层实现来完成栈的结构==

![image-20190127181325044](/Users/jack/Desktop/md/images/image-20190127181325044.png)
...
![image-20190128160158783](/Users/jack/Desktop/md/images/image-20190128160158783.png)
...
![img](/Users/jack/Desktop/md/images/70-8666635.png)

**解决链表中删除元素的问题：**![img](/Users/jack/Desktop/md/images/70-20190128171052447.png)

**对于最原始的链表，可看做是 头结点e + 一个更短的链表**

![img](/Users/jack/Desktop/md/images/70-20190128171058211.png)

​	如何通过得到解来解决原问题的解？**对原问题，就是没有考虑 头结点 ：如果头结点e != val(无需删除)，最终原问题的结果，就是头结点e +求得的==子问题链表==；如果需要删除的话，就是后续求出的链表**；![img](/Users/jack/Desktop/md/images/70-20190128171133276.png)
...
![img](/Users/jack/Desktop/md/images/70-20190128171157485.png)

​	一步步执行到，l==n\==2的时候，return结果，此时一步步递归回去计算结果。即x=0，然后res=0+10,再然后res=0+10+6

**链表中删除元素**

![img](/Users/jack/Desktop/md/images/70-20190128171212945.png)

**图解过程：**![img](/Users/jack/Desktop/md/images/70-20190128171225214.png)
...
![img](/Users/jack/Desktop/md/images/70-20190128171241404.png)

​	每个节点有两个指针(引用)

##### 2.循环链表

![img](/Users/jack/Desktop/md/images/70-20190128171254025.png)

​	设置虚拟头节点，尾节点不执行null，执行虚拟头节点，在虚拟头节点添加元素就相当于插入到链表中。

##### 3.数组链表（明确知道要处理元素的个数）

![img](/Users/jack/Desktop/md/images/70-20190128171253954.png)
...
![image-20190130130159092](/Users/jack/Desktop/md/images/image-20190130130159092.png)
...
![img](/Users/jack/Desktop/md/images/70-20190130130257634.png)
...
![image-20190130130323690](/Users/jack/Desktop/md/images/image-20190130130323690.png)
...
![image-20190130130400034](/Users/jack/Desktop/md/images/image-20190130130400034.png)

**特殊情况（有重复的话，该元素就相当于已经存在于树中，不做任何改变）**

![image-20190130130419592](/Users/jack/Desktop/md/images/image-20190130130419592.png)
...
![img](/Users/jack/Desktop/md/images/70-20190130130922343.png)
...
![image-20190130131025343](/Users/jack/Desktop/md/images/image-20190130131025343.png)

​	**二分搜索树的中序遍历结果元素是顺序的，这跟二分搜索树的性质相关** 

##### ==后序遍历：要访问节点放在最后，先访问左子树,再访问右子树；最后访问节点==

![img](/Users/jack/Desktop/md/images/70-20190130131045810.png)

### 4.3 分析这几种遍历结果：

​	**每个节点递归遍历的话会访问三次**

![img](/Users/jack/Desktop/md/images/70-20190130131123341.png)

**前序遍历:父节点在首位，故只有执行==最左侧(蓝色)的点时才会执行递归调用==**

![img](/Users/jack/Desktop/md/images/70-20190130131141654.png)

**中序遍历:节点在中间，故只有执行最中间(蓝色)的点时才会执行递归调用**

**![img](/Users/jack/Desktop/md/images/70-20190130131150452.png)**

**后序遍历:节点在后面，故只有执行最后面(蓝色)的点时才会执行递归调用**

![img](/Users/jack/Desktop/md/images/70-20190130131151465.png)

### 4.4 二分搜索树前序遍历的非递归实现

**前序遍历**

![img](/Users/jack/Desktop/md/images/70-20190130131203194.png)

**使用栈来模拟递归调用**

![img](/Users/jack/Desktop/md/images/70-20190130131238908.png)

## 5、二分搜索树的层序遍历

==前序、中序、后序遍历本质都是深度优先遍历==

层序遍历：根节点设置为第0层；先遍历第0层28、再遍历第1层16、30；再遍历第2层13、22、29、42；**逐层向下遍历的节点在广度上进行拓展；这种遍历方式也称为广度优先遍历；通常使用非递归的方式实现。**![img](/Users/jack/Desktop/md/images/70-20190131200712054.png)

图解：用**队列**的方式实现层序遍历

1.每一次一个元素入队，**从队尾的位置进入队列，初始化时将根节点入队**

![img](/Users/jack/Desktop/md/images/70-20190131200720617.png)

2.以后每一次要做的事就是先看队首(看该到谁开始遍历了)，出队的就是根节点28，访问28对其进行相应的操作，这样28就遍历完了；

![img](/Users/jack/Desktop/md/images/70-20190131200744004.png)

3.将根节点 28 的左右孩子（16和30）分别入队【**对于队列来说，是先进先出，所以我们按照从左到右的顺序进行入队，所以先入队16后入队30**】![img](/Users/jack/Desktop/md/images/70-20190131200806749.png)

4.现在的队首是16，将16拿出来，对其进行访问！

![img](/Users/jack/Desktop/md/images/70-20190131200814354.png)

5.将 16 的左右孩子 13 和 22 入队，

![img](/Users/jack/Desktop/md/images/70-20190131200825413.png) 

6.对队首元素 30 出队，对其进行操作，并将 30 的左右孩子（29和42）入队

![img](/Users/jack/Desktop/md/images/70-20190131200825936.png)

7.对队首元素 13 出队，对其进行操作，但13没有左右节点，他是个**叶子节点**；

![img](/Users/jack/Desktop/md/images/70-20190131200825456.png)

8.然后与上述相同，依次对队首元素进行操作，队列全部出队；【到这一步，队列的排序就与层序遍历相同了】

![img](/Users/jack/Desktop/md/images/70-20190131200836815.png)

广度优先遍历的意义：

![img](/Users/jack/Desktop/md/images/70-20190131200907865.png)
...
![img](/Users/jack/Desktop/md/images/70-20190131203214393.png)
...
![img](/Users/jack/Desktop/md/images/70-20190131203235670.png)

​	2.当要删除的节点不是叶子节点时，将该节点删除，**删除后将其整个右子树变为根节点的左子树即可**，因为左子树任意节点都小于右子树的任意节点

![image-20190131203253030](/Users/jack/Desktop/md/images/image-20190131203253030.png)
...
![img](/Users/jack/Desktop/md/images/70-20190131203333181.png)

在图中，**要删除58，就是要找到58的替代节点，找 58 （d）的后继**：所有元素中，离 58 最近的且比 58 大的节点，即图中的 59 (s)【即右子树中的最小值】

![image-20190131203357382](/Users/jack/Desktop/md/images/image-20190131203357382.png)

#### 另一种做法，找到左子树最大的树：![img](/Users/jack/Desktop/md/images/70-20190131203427579.png)
...
![img](/Users/jack/Desktop/md/images/70-20190131203515386.png)

**3.rank ：58 在整个树中所有的元素里排第几**

![img](/Users/jack/Desktop/md/images/70-20190131203529305.png)

**4.select:rank 的反向操作**

![img](/Users/jack/Desktop/md/images/70-20190131203535359.png)

**5.维护 size 的二分搜索树**

![img](/Users/jack/Desktop/md/images/70-20190131203540508.png)

**6.支持重复元素的二分搜索树（定义左子树的节点 <= 父节点的值,count记录重复元素个数）**

![image-20190131203552423](/Users/jack/Desktop/md/images/image-20190131203552423.png)
...
![image-20190131230248395](/Users/jack/Desktop/md/images/image-20190131230248395.png)
...
![img](/Users/jack/Desktop/md/images/70-20190131230358634.png)
...
![img](/Users/jack/Desktop/md/images/70-20190131230412930.png)

分析过程：

![img](/Users/jack/Desktop/md/images/70-20190131230425869.png)

![img](/Users/jack/Desktop/md/images/70-20190131230425929.png)

**==可知：n 与 h 之间的关系为 h=O(log n),可得：==**

![img](/Users/jack/Desktop/md/images/70-20190131230426296.png)

log n 与 n 的差距【log n 的时间复杂度很小，特别快】，==在高阶算法中的 nlog n 的复杂度比 n2 的复杂度快 很多很多倍==

![img](/Users/jack/Desktop/md/images/70-20190131230441530.png)

**使用二分搜索树，==复杂度最坏的情况就是排成一列（相当于链表）==**

![img](/Users/jack/Desktop/md/images/70-20190131230441877.png)

#### 完整版复杂度分析：

![img](/Users/jack/Desktop/md/images/70-20190131230441889.png)
...
![image-20190131231354264](/Users/jack/Desktop/md/images/image-20190131231354264.png)

实现机制：

![img](/Users/jack/Desktop/md/images/70-20190131231416464.png)
...
![img](/Users/jack/Desktop/md/images/70-20190131231533166.png)
...
![img](/Users/jack/Desktop/md/images/70-20190131231556018.png)
...
![img](/Users/jack/Desktop/md/images/70-20190201123547070.png)

与普通队列的区别：**出队元素是优先级最高的元素；队首元素也是优先级最高的元素，而不是最早进入队列的元素；**

![img](/Users/jack/Desktop/md/images/70-20190201123557799.png)
...
![img](/Users/jack/Desktop/md/images/70-20190201123621402.png)
...
![image-20190201123633150](/Users/jack/Desktop/md/images/image-20190201123633150.png)
...
![img](/Users/jack/Desktop/md/images/70-20190201123722316.png)

2. 添加 52 后，52 > 16 ，不满足条件 父亲节点 > 孩子节点；要进行调整：从 52 开始一路与其父亲节点做比较并交换顺序

![img](/Users/jack/Desktop/md/images/70-20190201123729499.png)

将 52 与 16 交换顺序；但 52 > 41 ,继续交换位置

![img](/Users/jack/Desktop/md/images/70-20190201123729808.png)

这时，62 > 52 ,符合堆的性质  

![img](/Users/jack/Desktop/md/images/70-20190201123751262.png)
...
![img](/Users/jack/Desktop/md/images/70-20190201123808955.png)

过程：1.访问根节点，数组中索引为 0 的元素；将其拿走之后，对整个堆来说，可以看成是有两颗子树；

![img](/Users/jack/Desktop/md/images/70-20190201123819989.png)

2.将堆中的最后一个元素（即 16）顶到堆顶去；数组0变为16并删掉数组中10对应的16

![img](/Users/jack/Desktop/md/images/70-20190201123844488.png)
...
![img](/Users/jack/Desktop/md/images/70-20190201123853305.png)

2.选择孩子中较大的元素，交换位置；

![img](/Users/jack/Desktop/md/images/70-20190201123858725.png)

3.父亲节点继续与左右孩子对比，重复上面步骤

![img](/Users/jack/Desktop/md/images/70-20190201123905623.png)

4.16 > 15，满足堆的性质，最终形态为下图

![img](/Users/jack/Desktop/md/images/70-20190201123905334.png)
...
![img](/Users/jack/Desktop/md/images/70-20190201124159553.png)

从 22 开始，不断进行下沉操作

![img](/Users/jack/Desktop/md/images/70-20190201124212955.png)

索引为3 的是13，对其进行下沉操作，交换 41 和 13；

![img](/Users/jack/Desktop/md/images/70-20190201124212972.png)

索引为 2 的是19，对其进行下沉操作

![img](/Users/jack/Desktop/md/images/70-20190201124222978.png)

对索引为 1 、0 的继续进行下沉，得到最终的二叉树

![img](/Users/jack/Desktop/md/images/70-20190201124222987.png)
...
![img](/Users/jack/Desktop/md/images/70-20190202184612787.png)
...
![img](/Users/jack/Desktop/md/images/70-20190203124147778.png)

2. 7-15 绿色

![img](/Users/jack/Desktop/md/images/70-20190203124147753.png)

3. 1-5 蓝色

![img](/Users/jack/Desktop/md/images/70-20190203124202238.png)

4. 6-12 红色

![img](/Users/jack/Desktop/md/images/70-20190203124201704.png)
...
![img](/Users/jack/Desktop/md/images/70-20190203124214800.png)

另一类经典问题：区间查询

![img](/Users/jack/Desktop/md/images/70-20190203124223106.png)

查询一个区间 [ i,j ] 的最大值，最小值，或者**区间数字和**  【实质：基于区间的统计查询】

实际使用情况：

![img](/Users/jack/Desktop/md/images/70-20190203124230806.png)

==使用线段树的必要性：极大降低时间复杂度==

![img](/Users/jack/Desktop/md/images/70-20190203124230525.png)
...
## ![img](/Users/jack/Desktop/md/images/70-20190203124253568.png)

例 ：10 个元素的线段树，区间的元素是固定的。

![img](/Users/jack/Desktop/md/images/70-20190203124307203.png)
...
![img](/Users/jack/Desktop/md/images/70-20190203124325492.png)

如果区间有 n 个元素，用数组表示需要多少个节点?

分析：

![img](/Users/jack/Desktop/md/images/70-20190203124333289.png)

![img](/Users/jack/Desktop/md/images/70-20190203124332964.png)
...
![img](/Users/jack/Desktop/md/images/70-20190203124341482.png)
...
![img](/Users/jack/Desktop/md/images/70-20190203124402147.png)

![img](/Users/jack/Desktop/md/images/70-20190203124401755.png)
...
![img](/Users/jack/Desktop/md/images/70-20190203124428083.png)

方案：懒惰更新--**使用 lazy 数组记录未记录内容**

### 2.二维线段树

![img](/Users/jack/Desktop/md/images/70-20190203124427862.png)

### 3.动态线段树

![img](/Users/jack/Desktop/md/images/70-20190203124428960.png)
...
![image-20190206212113203](/Users/jack/Desktop/md/images/image-20190206212113203.png)
...
在 isConnected(p,q)   ---查询中，只需要查看  p 和 q 所对应的 id 值是否相等即可，**将查看  p 和 q 背后的 id 是谁的过程抽象为函数：find(p) == find(q)** ,这种方式为==Quick Find,其时间复杂度为 O(1)==
...
如果让节点7 和 节点2 合并 ，即让 节点7 所在的 根节点5 ，指向 节点2 即可；

如果让节点7 和 节点3 合并 ，即让 节点7 所在的 根节点5 ，指向 节点3 所在树的 根节点2 即可；

![img](/Users/jack/Desktop/md/images/70-20190203204216821.png)

**Quick Union:并查集不是一个树结构，而是森林结构 ，即里面存在很多树 ，在初始的情况下有 10 棵树，每棵树只有一个节点；**![image-20190203204234890](/Users/jack/Desktop/md/images/image-20190203204234890.png)
...
**并查集的实现由于对真正合并的元素如果不做形状上的判断，这个合并的过程会不断增加树的高度，甚至演化为链表；**

解决办法：考虑(size)当前这棵树整体有多少个节点,例如 union 4,9,正常操作如下图

![img](/Users/jack/Desktop/md/images/70-20190203204803619.png)

这时的高度为 4，但完全可以**让 9 指向 4 所在的根节点 8 ，即 9 指向 8；高度变为 3**

![img](/Users/jack/Desktop/md/images/70-20190203204810874.png)

让节点个数少的树指向节点个数多的树的根节点

### 基于rank的优化【树的高度】

![img](/Users/jack/Desktop/md/images/70-20190203204929998.png)

执行 union 4,2 ，以 size 优化方式执行，因为2所在的树节点总数为6，而4所在的树节点总数为3，所以是8指向7，所以高度变高了。

![img](/Users/jack/Desktop/md/images/70-20190203204929987.png)

更合理的方式： **在每一个节点上记录以这个节点为根的对应的树，其最大深度为多少，在真正合并的时候，应该使用深度比较低的那棵树向深度比较高的树进行合并；**整体更加合理；称为基于rank 的优化，rank[i] 表示根节点为 i 的树的高度
...
补充：在方式 5 中也可以变为理想状态下的情况【不是通过递归 ，通过 循环遍历 来实现】
...
​	在二分搜索树中，如果是顺序添加进搜索树的话，则会排成一列，成为链表，从而极大的降低二分搜索树的执行效率；

![image-20190208215633820](/Users/jack/Desktop/md/images/image-20190208215633820.png)

解决这个问题：在二分搜索树的基础上添加一定的机制，使得二分搜索树能够维持平衡二叉树的性质；

## 1.各种树的比较

AVL : 最经典的平衡二叉树；(发明人：Adelson-Velsky 和 E.M.Landis 名字缩写为 AVL),最早的自平衡二分搜索树结构；

平衡二叉树：【[详解](https://www.cnblogs.com/zhangbaochong/p/5164994.html)】又被称为AVL树，**它是一棵空树或==对任意一个节点==，它的左右两个子树的高度差的绝对值不超过1，并且左右两个子树都是一棵平衡二叉树。**这个方案很好的解决了二叉查找树退化成链表的问题，把插入，查找，删除的时间复杂度最好情况和最坏情况都维持在O(logN)。但是频繁旋转会使插入和删除牺牲掉O(logN)左右的时间，不过相对二叉查找树来说，时间上稳定了很多。平衡二叉树的高度和节点数量之间关系：O(log n); 

![img](/Users/jack/Desktop/md/images/70-20190208220131776.png)

判断是否为 平衡二叉树条件：==平衡因子[节点的左子树高度 减 右子树高度]的绝对值 < 2 ;==

下图不是平衡二叉树

![img](/Users/jack/Desktop/md/images/70-20190208220142006.png)

蓝色数字表示节点之间的高度差。	两颗子树之差

**满二叉树：一定是平衡二叉树；除了叶子节点外，所有其他的节点都有左右两个子树；让整棵树的状态达到最低的状态；**

![img](/Users/jack/Desktop/md/images/70-20190208220202190.png)

**完全二叉树：是平衡二叉树；**将所有元素按照二叉树的形状一层一层“铺开”，有可能有非叶子节点其右子树是空的，整体而言，**空缺部分一定在右下部分，叶子节点最大深度值与最小深度值相差不会超过 1；**

![img](/Users/jack/Desktop/md/images/70-20190208220209431.png)

线段树：也是平衡二叉树；不是完全二叉树，因为空出来的部分不一定在树的右下角的位置，但整体而言，叶子节点要么在最后一层，要不在倒数第二层，整体叶子节点的深度相差不会超过 1 ；(因为一开始都是进行二分的)

![img](/Users/jack/Desktop/md/images/70-20190208220215197.png)
...
![img](/Users/jack/Desktop/md/images/70-20190208220300777.png)

需要从根节点开始，一路下来寻找到该节点正确的插入位置，**正确的插入位置都是叶子节点的位置**

![img](/Users/jack/Desktop/md/images/70-20190208220357333.png)

​	由于新添加节点才会导致整棵二分搜索树不满足平衡性；**不平衡节点只有可能发生在从插入位置开始，向其父元素中找，会发生在其父节点与祖先节点中，因为插入新节点后，其父节点与祖先节点左右子树需要进行更新；在更新后，平衡因子可能 > 1 ;**

![img](/Users/jack/Desktop/md/images/70-20190208220404800.png)

==故维护平衡的时机：加入节点后，沿着节点向上维护平衡性；==

**图解(蓝色数字表示平衡因子，节点左右子树高度之差)：**

#### 1.不断在一侧添加节点，导致树不平衡，需要进行平衡维护

![img](/Users/jack/Desktop/md/images/70-20190208220413509.png)

#### 2.插入的元素在不平衡的节点的左侧的左侧

![img](/Users/jack/Desktop/md/images/70-20190208220421715.png)
...
左子树高度比右子树高度要高，且高度差 > 1;左子树高度 >= 右子树；

如图中，根据二分搜索树特性，右子树大于父结点大于左子树存在关系：T1 < z < T2 < x < T3 < y < T4

![img](/Users/jack/Desktop/md/images/70-20190208220433579.png)

经过 右旋转 操作，使得 y节点 保持平衡性，且整棵子树不能失去 二分搜索树 的性质

##### 右旋转过程：

1.让 x节点 的右子树 T3，**变成 以 y节点 为根的子树** ，x.right = y

![img](/Users/jack/Desktop/md/images/70-20190208220505868.png)

2.**让 y节点的左子树 变成 x节点 右子树连接的 T3**， y.left = T3

![img](/Users/jack/Desktop/md/images/70-20190208220512198.png)

3.让 x节点 变成新的二叉树的根节点，这样的过程为 右旋转，相当于 y节点  顺时针的旋转到了 x节点 右子树的位置；顺时针对于 x节点 来看就是 向右旋转 ；得到的二叉树满足二分搜索树与平衡二叉树的性质

![img](/Users/jack/Desktop/md/images/70-20190208220519767.png)

![image-20190208220536583](/Users/jack/Desktop/md/images/image-20190208220536583.png)

#### 2.左旋转：

##### 右子树高度比左子树高度要高，且高度差 > 1;右子树高度 >= 左子树；

如图中，存在关系：T4 < y < T3 < x < T1 < z < T2;插入的元素在不平衡节点的右侧的右侧

![img](/Users/jack/Desktop/md/images/70-20190208220550443.png)

##### 左旋转过程：

1.让 x节点 的左子树 T3，变成 以 y节点 为根的子树 ，x.left = y

![img](/Users/jack/Desktop/md/images/70-20190208220558928.png)

2.让 y节点的右子树 变成 x节点 左子树连接的 T3， y.right = T3

![img](/Users/jack/Desktop/md/images/70-20190208220606167.png)

3.让 x节点 变成新的二叉树的根节点，这样的过程为 左旋转，相当于 y 节点  逆时针的旋转到了 x节点 左子树的位置；逆时针对于 x节点 来看就是 向左旋转 ；得到的二叉树满足二分搜索树与平衡二叉树的性质

![img](/Users/jack/Desktop/md/images/70-20190208220612271.png)

## 3.LR 和 RL(左孩子的右孩子和右孩子的左孩子)

​	插入的元素在不平衡的节点的左侧的右侧；不能简单的使用左旋转和右旋转；

![img](/Users/jack/Desktop/md/images/70-20190208220936557.png)

### LL 和 RR (左孩子的左孩子和右孩子的右孩子)

LL：新插入的节点在 向上回溯 找到的 第一个不平衡节点 的 左孩子 的 左侧；【右旋转即可】

RR：新插入的节点在 向上回溯 找到的 第一个不平衡节点 的 右孩子 的 右侧；【左旋转即可】

![img](/Users/jack/Desktop/md/images/70-20190208220945666.png)

LR:新插入的节点在 向上回溯 找到的 第一个不平衡节点 的 左孩子 的 右侧；

![img](/Users/jack/Desktop/md/images/70-20190208220954161.png)

##### LR 处理过程：

**首先对 x 进行左旋转，将其转换为 LL 的情况；再用处理 LL 的方法进行右旋转即可；**

![img](/Users/jack/Desktop/md/images/70-20190208221156450.png)

RL:新插入的节点在 向上回溯 找到的 第一个不平衡节点 的 右孩子 的 左侧；

![img](/Users/jack/Desktop/md/images/70-20190208221213330.png)

##### RL处理过程：

首先对 x 进行右旋转，将其转换为 RR 的情况；再用处理 RR 的方法进行左旋转即可；

![img](/Users/jack/Desktop/md/images/70-20190208221219922.png)
...
![img](/Users/jack/Desktop/md/images/70-20190208222259906.png)

红黑树是二分搜索树，并在二分搜索树的基础上添加一些性质确保其不会退化为链表，保证其是平衡二叉树。**红黑树是一种近似平衡的二叉查找树，它能够确保任何一个节点的左右子树的高度差不会超过二者中较低那个的一倍**。

**《算法导论》中的具体规定：**

1.每个节点要么是红色，要么是黑色；

2.根节点是黑色的，红色节点不能连续（也即是，红色节点的孩子和父亲不能同时是红色）。
...
### 2-3 树
1.满足二分搜索树的基本性质(左孩子小于父节点小于右孩子)

2.不是一种二叉树，它有两种节点，一种可存放一个元素【左孩子<a<右孩子】，一种可存放两个元素【3个孩子，左孩子<b<中间孩子<c<右孩子】

![img](/Users/jack/Desktop/md/images/70-20190208222348274.png)

​	==一个2节点可以有左右两个孩子，一个3节点可以有三个孩子==

**3.==每个节点有 2 或 3 个 孩子，故称为 2-3 树==**

图示：

![img](/Users/jack/Desktop/md/images/70-20190208222357437.png)

2-3 树性质：它==是一颗绝对平衡的树==【**从根节点到任意叶子节点所经过的节点数量一定是相同的，对任意节点，左右子树的高度一定是相等的**】

##### 新节点永远不会去 空 的位置，只会和最后找到的叶子节点做融合
...
2. 添加元素 37 ，因为 37 < 42 ，所以 37 应放在 42 的左子树中，而由于 42 的左子树为空，【==新节点永远不会去 空 的位置，只会和最后找到的叶子节点做融合==】新节点 37 将融合到 在添加过程中所找到的最后一个叶子节点上，叶子节点就是 42 这个节点，所以，会发生 节点的融合，由 2节点 变为 3节点![image-20190223154043055](/Users/jack/Desktop/md/images/image-20190223154043055.png)

3. 再添加元素 12 ，因为 12 < 37 ,所以 12 应放在 37 的左子树中，而由于 37 的左子树为空【新节点永远不会去 空 的位置，只会和最后找到的叶子节点做融合】故虽然已经是 3节点，但仍然先融合，暂时形成 4节点![img](/Users/jack/Desktop/md/images/70-0907672.png)

4. **2-3树 中最多有 3节点**，所以将 4节点 分裂成 一棵子树， 4节点 转换为 由 3个 2节点 组成的一棵平衡的树，如图所示，可以将其理解为二分搜索树与 2-3树，只不过每个节点都是 2节点，同时这棵树保持着绝对的平衡![img](/Users/jack/Desktop/md/images/70-20190223154124825.png)

5. 在树中再添加新元素 18，根节点是37 ，要将 18 添加到其左子树12 中 ，18 > 12 故将其添加到 12 的右子树中去 ，此时 12 的右子树 已经为空【==新节点永远不会去 空 的位置，只会和最后找到的叶子节点做融合==】,这棵树保持着绝对的平衡![img](/Users/jack/Desktop/md/images/70-20190208222506095.png)

6. 在树中再添加新元素 6，根节点是37 ，要将 18 添加到其左子树(包含 12 18 的3节点) 中 ，6 < 12 故将其添加到 3节点 的左子树中去 ，此时 3节点 的左子树 为空【新节点永远不会去 空 的位置，只会和最后找到的叶子节点做融合】，故先融合为 4节点

   ![img](/Users/jack/Desktop/md/images/70-20190208222513163.png)

7. 将 4节点 拆解，变为 包含 3个 2节点 的子树

   ![img](/Users/jack/Desktop/md/images/70-20190208222521733.png)

   

   如果拆分为上图所示，此时的 2-3 树不是 **绝对 平衡的树**，对 2-3树 来说，如果其叶子节点本身已经是一个 3节点 了，添加一个节点变为 4节点 ，变为如图所示，则 12 需要与其父节点 37 进行融合，37 是 2节点，12 和 37 可以直接融合为 3节点，此时该树仍然 绝对平衡。![img](/Users/jack/Desktop/md/images/70-20190208222806549.png)

8.在树中再添加新元素 11，根节点是 12 37 的3节点，要将 11 添加到其左子树6中 ，**6 < 11 故将其添加到 6 的右子树中去 ，此时 6 的右子树 为空【新节点永远不会去 空 的位置，只会和最后找到的叶子节点做融合】，故先融合为 3节点**![img](/Users/jack/Desktop/md/images/70-20190208222820275.png)

9.在树中再添加新元素 5，根节点是 12 37 的3节点，要将 5 添加到其左子树 6 11 的3节点 中 ，5 < 6 故将其添加到 6 11 的3节点左子树中去 ，此时 6 11 的3节点 的左子树 为空【新节点永远不会去 空 的位置，只会和最后找到的叶子节点做融合】，故先融合为 4节点。![img](/Users/jack/Desktop/md/images/70-20190208222838062.png)

将 4节点 拆解，变为 包含 3个 2节点 的子树

![img](/Users/jack/Desktop/md/images/70-20190208222842608.png)
...
**![img](/Users/jack/Desktop/md/images/70-20190208222848733.png)**

将 4节点 拆解，变为 包含 3个 2节点 的子树，此时，树仍然 绝对平衡并保持着 2-3树的性质

![img](/Users/jack/Desktop/md/images/70-20190208222854649.png)

### 总结：![image-20190208222929621](/Users/jack/Desktop/md/images/image-20190208222929621.png)

![image-20190208222950479](/Users/jack/Desktop/md/images/image-20190208222950479.png)

## 3.红黑树与2-3树的等价性

![img](/Users/jack/Desktop/md/images/70-20190208223001326.png)

表示 b 和 c 是并列关系(一起存放在 3节点 中)，则将其 连线 设置为 红色； 将其还原为 二分搜索树中的样子

![img](/Users/jack/Desktop/md/images/70-20190208223001334.png)

表示 红色连线的方法：**由于每一个节点只有一个父亲(每一个节点和其父亲节点相连接的边只有一条线)，可以对 b节点 做特殊标识，使其为红色，==表示 b节点 与 c节点 在 2-3树 中是一起存放在 3节点中==**【所有的红色节点都是左倾斜的，即每个红色节点都可以向左倾斜】

![img](/Users/jack/Desktop/md/images/70-20190208223013769.png)

![image-20190208223030543](/Users/jack/Desktop/md/images/image-20190208223030543.png)
...
3.每个叶子节点(最后的空节点)是黑色的【定义 空节点 为黑色】

4.如果一个节点是红色的，则其两个孩子节点都是黑色的【黑色节点的右孩子为黑色】

5.==从任意一个节点到叶子节点(最后的空节点)，经过的黑色节点是一样多的==【核心】

 分析：

​	2-3树是 绝对平衡的，所以**所有的叶子节点都在同一层上**，其深度是一样的；从任意节点出发，有固定的深度，从该节点向下到达(可到达)的叶子节点，向下的深度也是一样的，其经过的节点数量是一样的；

​	**对应到 红黑树 中，则经过的黑色节点是一样多的。**【==红黑树 是保持 “黑平衡” 的二叉树，最大高度：2log n ,增删改查都是时间复杂度：O(log n)==】，2logn表示可能每个节点都是三节点，所以会多了logn红色节点
...
![img](/Users/jack/Desktop/md/images/70-20190208223057766.png)

![img](/Users/jack/Desktop/md/images/70-20190208223112200.png)
...
![image-20190208223150628](/Users/jack/Desktop/md/images/image-20190208223150628.png)

**解决方法：左旋转，上图 经过 左旋转 变为 下图**

![img](/Users/jack/Desktop/md/images/70-20190208223211817.png)

左旋转过程**（T1<37<T2<42<T3）**：

1.假设根节点为 node，node 的右孩子为 x

![img](/Users/jack/Desktop/md/images/70-20190208223219099.png)

2.node.right = x.left，让 node 的右孩子 为 x 的左子树, 仍然保持二分搜索树性质

![img](/Users/jack/Desktop/md/images/70-20190208223219670.png)

3.x.right = node, x 的左子树连接上 node ,完成左旋转，37 从原来 42 的父亲 变为 42 的右孩子，相当于逆时针旋转，在 37 来看是左旋转

![img](/Users/jack/Desktop/md/images/70-20190208223227644.png)

**4.对于红黑树来说，需要维护颜色信息**

x.color = node.color **,新的根节点是 x节点，x节点的颜色要和以前的节点 node 的颜色是一样的**

![img](/Users/jack/Desktop/md/images/70-20190208223235428.png)

node 变为 x 的左孩子，**对应到 2-3 树中，还是临时的 4节点，要让 node 的颜色变为 红色，node.color = RED；表示它和它的父亲节点 42 是融合在一起的 ；**这样就完成了整个左旋转过程

![img](/Users/jack/Desktop/md/images/70-20190208223242242.png)

## 5.颜色翻转和右旋转

### 红黑树添加新元素

![image-20190208223356939](/Users/jack/Desktop/md/images/image-20190208223356939.png)

![image-20190208223415267](/Users/jack/Desktop/md/images/image-20190208223415267.png)

![image-20190208223428968](/Users/jack/Desktop/md/images/image-20190208223428968.png)

在红黑树中，需要用到 右旋转

1.假设根节点为 node，node 的左孩子为 x ，

![img](/Users/jack/Desktop/md/images/70-20190208223511941.png)

2.node.left = T1，让 node 的左子树 为 左孩子的右子树, 仍然保持二分搜索树性质

![img](/Users/jack/Desktop/md/images/70-20190208223519262.png)

3.x.right = node ,完成右旋转，42 从原来 37的父亲 变为 37的右孩子，相当于顺时针旋转，在 37 来看是右旋转

![img](/Users/jack/Desktop/md/images/70-20190208223519254.png)

4.对于红黑树来说，需要维护颜色信息

**x.color = node.color ,新的根节点是 x节点，x节点的颜色要和以前的节点 node 的颜色是一样的**

![img](/Users/jack/Desktop/md/images/70-20190208223536519.png)

node 变为 x 的右孩子，对应到 2-3树中，还是临时的 4节点，要让 node 的颜色变为 红色，node.color = RED；表示它和它的父亲节点 42 是融合在一起的 ；这样就完成了整个右旋转过程

![img](/Users/jack/Desktop/md/images/70-20190208223542653.png)

### 总结：

![image-20190208223620296](/Users/jack/Desktop/md/images/image-20190208223620296.png)



![image-20190208223636429](/Users/jack/Desktop/md/images/image-20190208223636429.png)

![image-20190208223653537](/Users/jack/Desktop/md/images/image-20190208223653537.png)

![image-20190208223711739](/Users/jack/Desktop/md/images/image-20190208223711739.png)

红黑树性能总结：

![img](/Users/jack/Desktop/md/images/70-20190208223742054.png)
...
![img](/Users/jack/Desktop/md/images/70-20190225154100536.png)

哈希表就是一种以 键-值(key-indexed) 存储数据的结构，我们只要输入待查找的值即key，即可查找到其对应的值。【[详解](https://www.cnblogs.com/yangecnu/p/Introduce-Hashtable.html)】

哈希的思路很简单，如果所有的键都是整数，那么就可以使用一个简单的**无序数组**来实现：将键作为索引，值即为其对应的值，这样就可以快速访问任意键的值。这是对于简单的键的情况，我们将其扩展到可以处理更加复杂的类型的键。
...
![img](/Users/jack/Desktop/md/images/70-20190225154210481.png)

大整数：

![img](/Users/jack/Desktop/md/images/70-20190225154231130.png)

![img](/Users/jack/Desktop/md/images/70-20190225154231853.png)

![img](/Users/jack/Desktop/md/images/70-20190225154231925.png)

​	模一个合数出现哈希冲突的概率比较大，模一个素数出现哈希冲突的概率比较低。上图左边两个数表示在取右边prime作为素数时的范围。

### 2.浮点型

在计算机中都是 32位 或 64位 的二进制表示，只不过计算机解析成了浮点数

 ![img](/Users/jack/Desktop/md/images/70-20190225154252054.png)
...
### ![image-20190225154304189](/Users/jack/Desktop/md/images/image-20190225154304189.png)

### 4.复合类型

方法：转成 整型 处理

![image-20190225154331024](/Users/jack/Desktop/md/images/image-20190225154331024.png)
...
1.将 元素k1 转换为 哈希表中对应的索引值，这里与0x7fffffff，是为了消除key的符号，整型的最高位是符号位，1表示负数，0表示正数

![img](/Users/jack/Desktop/md/images/70-20190225154416601.png)

2.假如计算后 k1 的索引对应是 4 的话，在哈希表索引为 4 的位置存储 k1

![img](/Users/jack/Desktop/md/images/70-20190225154425015.png)

3.再加入元素 k2 ，则用相同的方法计算出索引值 为 1，插入到哈希表中

![img](/Users/jack/Desktop/md/images/70-20190225154425012.png)

4.再加入元素 k3 ，则用相同的方法计算出索引值 为 1，产生哈希冲突，但仍然将其插入到哈希表中，**将其作为 链表 即可**

![img](/Users/jack/Desktop/md/images/70-20190225154448663.png)

链地址法：对整个哈希表，开辟 m 个空间，对于每一个空间，由于有哈希冲突的存在，其本质上都是存储 一个链表（==查找表==），**查找表的底层实现不一定是链表，也可以使用树结构**，如图![img](/Users/jack/Desktop/md/images/70-20190225154455846.png)

（HashMap 本质就是一个 TreeMap 数组 ,而HashSet 本质就是一个 TreeSet 数组）

【==Java8 之前，每一个位置对应一个链表，Java8 开始，当哈希冲突达到一定程度(即每个位置存储的元素达到一定的数量时)，每一个位置从链表转成红黑树==】

## 4、哈希表的动态空间处理与复杂度分析

![img](/Users/jack/Desktop/md/images/70-20190225154527402.png)
...
![image-20190225154629490](/Users/jack/Desktop/md/images/image-20190225154629490.png)

知哈希表均摊时间复杂度为：O(1)

![img](/Users/jack/Desktop/md/images/70-20190225154637837.png)

代码中的Bug: Comparable(可比较性矛盾)，TreeMap的key有可比性

![img](/Users/jack/Desktop/md/images/70-20190225154647417.png)
...
存入一个素数数组，扩容的时候依次使用数组中的值即可。

## ![img](/Users/jack/Desktop/md/images/70-20190225154702349.png)
...
![img](/Users/jack/Desktop/md/images/70-20190225154724019.png)

开放地址法和上述方法相反，**对于哈希表中的每一个地址，所有哈希值的元素都有机会进入**

![img](/Users/jack/Desktop/md/images/70-20190225154736965.png)

每一个地址就是直接存元素，**11 和 31 产生哈希冲突，就从索引为 1 的地方向下找，空的地方是索引为 2 的地方，故将 31 放在 2 中；**

![img](/Users/jack/Desktop/md/images/70-20190225214106479.png)

再插入元素 81，发生哈希冲突，原理同上，插入到索引 3 的位置【==此方法：线性探测，遇到哈希冲突 +1==】

开发地址法使用的其实是线性探测，也可以用平方探测：遇到哈希冲突 +1 +4 + 9 ...【提高性能】或二次哈希：遇到哈希冲突 +hash2(key)

更多方法：

![img](/Users/jack/Desktop/md/images/70-20190225154757164.png)

### 总结：

![image-20190225154813506](/Users/jack/Desktop/md/images/image-20190225154813506.png)
