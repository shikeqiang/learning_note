...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190126164245218.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190131200744004.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203203312861.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203204154287.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203204207632.png)

如果让节点7 和 节点2 合并 ，即让 节点7 所在的 根节点5 ，指向 节点2 即可；

如果让节点7 和 节点3 合并 ，即让 节点7 所在的 根节点5 ，指向 节点3 所在树的 根节点2 即可；

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203204216821.png)

**Quick Union:并查集不是一个树结构，而是森林结构 ，即里面存在很多树 ，在初始的情况下有 10 棵树，每棵树只有一个节点；**![image-20190203204234890](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190203204234890.png)

如果执行 union 4,3 操作

![image-20190203204249770](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190203204249770.png)

再执行 union 3,8

![image-20190203204320883](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190203204320883.png)

![image-20190203204353436](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190203204353436.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203204803619.png)

这时的高度为 4，但完全可以**让 9 指向 4 所在的根节点 8 ，即 9 指向 8；高度变为 3**

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203204810874.png)

让节点个数少的树指向节点个数多的树的根节点

### 基于rank的优化【树的高度】

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203204929998.png)

执行 union 4,2 ，以 size 优化方式执行，因为2所在的树节点总数为6，而4所在的树节点总数为3，所以是8指向7，所以高度变高了。

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203204929987.png)

更合理的方式： **在每一个节点上记录以这个节点为根的对应的树，其最大深度为多少，在真正合并的时候，应该使用深度比较低的那棵树向深度比较高的树进行合并；**整体更加合理；称为基于rank 的优化，rank[i] 表示根节点为 i 的树的高度

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203205046523.png)

### 路径压缩(Path Compression)

由上述几种优化方式，知

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203205128174.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203205215568.png)

2.

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203205215620.png)

3.

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203205215602.png)

理想状况：通过 递归 实现

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203205237635.png)

指向父节点的父节点

补充：在方式 5 中也可以变为理想状态下的情况【不是通过递归 ，通过 循环遍历 来实现】

![image-20190203205301582](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190203205301582.png)

时间复杂度：O(h) --- 严格意思上：O(log  *n)

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190203205313254.png)

# 十二、平衡二叉树与AVL

​	在二分搜索树中，如果是顺序添加进搜索树的话，则会排成一列，成为链表，从而极大的降低二分搜索树的执行效率；

![image-20190208215633820](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190208215633820.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220131776.png)

判断是否为 平衡二叉树条件：==平衡因子[节点的左子树高度 减 右子树高度]的绝对值 < 2 ;==

下图不是平衡二叉树

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220142006.png)

蓝色数字表示节点之间的高度差。	两颗子树之差

**满二叉树：一定是平衡二叉树；除了叶子节点外，所有其他的节点都有左右两个子树；让整棵树的状态达到最低的状态；**

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220202190.png)

**完全二叉树：是平衡二叉树；**将所有元素按照二叉树的形状一层一层“铺开”，有可能有非叶子节点其右子树是空的，整体而言，**空缺部分一定在右下部分，叶子节点最大深度值与最小深度值相差不会超过 1；**

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220209431.png)

线段树：也是平衡二叉树；不是完全二叉树，因为空出来的部分不一定在树的右下角的位置，但整体而言，叶子节点要么在最后一层，要不在倒数第二层，整体叶子节点的深度相差不会超过 1 ；(因为一开始都是进行二分的)

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220215197.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220300777.png)

需要从根节点开始，一路下来寻找到该节点正确的插入位置，**正确的插入位置都是叶子节点的位置**

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220357333.png)

​	由于新添加节点才会导致整棵二分搜索树不满足平衡性；**不平衡节点只有可能发生在从插入位置开始，向其父元素中找，会发生在其父节点与祖先节点中，因为插入新节点后，其父节点与祖先节点左右子树需要进行更新；在更新后，平衡因子可能 > 1 ;**

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220404800.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220413509.png)

#### 2.插入的元素在不平衡的节点的左侧的左侧

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220421715.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220433579.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220505868.png)

2.**让 y节点的左子树 变成 x节点 右子树连接的 T3**， y.left = T3

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220512198.png)

3.让 x节点 变成新的二叉树的根节点，这样的过程为 右旋转，相当于 y节点  顺时针的旋转到了 x节点 右子树的位置；顺时针对于 x节点 来看就是 向右旋转 ；得到的二叉树满足二分搜索树与平衡二叉树的性质

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220519767.png)

![image-20190208220536583](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190208220536583.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220550443.png)

##### 左旋转过程：

1.让 x节点 的左子树 T3，变成 以 y节点 为根的子树 ，x.left = y

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220558928.png)

2.让 y节点的右子树 变成 x节点 左子树连接的 T3， y.right = T3

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220606167.png)

3.让 x节点 变成新的二叉树的根节点，这样的过程为 左旋转，相当于 y 节点  逆时针的旋转到了 x节点 左子树的位置；逆时针对于 x节点 来看就是 向左旋转 ；得到的二叉树满足二分搜索树与平衡二叉树的性质

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220612271.png)

## 3.LR 和 RL(左孩子的右孩子和右孩子的左孩子)

​	插入的元素在不平衡的节点的左侧的右侧；不能简单的使用左旋转和右旋转；

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220936557.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220945666.png)

LR:新插入的节点在 向上回溯 找到的 第一个不平衡节点 的 左孩子 的 右侧；

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208220954161.png)

##### LR 处理过程：

**首先对 x 进行左旋转，将其转换为 LL 的情况；再用处理 LL 的方法进行右旋转即可；**

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208221156450.png)

RL:新插入的节点在 向上回溯 找到的 第一个不平衡节点 的 右孩子 的 左侧；

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208221213330.png)

##### RL处理过程：

首先对 x 进行右旋转，将其转换为 RR 的情况；再用处理 RR 的方法进行左旋转即可；

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208221219922.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208222259906.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208222348274.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208222357437.png)
...
2. 添加元素 37 ，因为 37 < 42 ，所以 37 应放在 42 的左子树中，而由于 42 的左子树为空，【==新节点永远不会去 空 的位置，只会和最后找到的叶子节点做融合==】新节点 37 将融合到 在添加过程中所找到的最后一个叶子节点上，叶子节点就是 42 这个节点，所以，会发生 节点的融合，由 2节点 变为 3节点![image-20190223154043055](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190223154043055.png)

3. 再添加元素 12 ，因为 12 < 37 ,所以 12 应放在 37 的左子树中，而由于 37 的左子树为空【新节点永远不会去 空 的位置，只会和最后找到的叶子节点做融合】故虽然已经是 3节点，但仍然先融合，暂时形成 4节点![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-0907672.png)

4. **2-3树 中最多有 3节点**，所以将 4节点 分裂成 一棵子树， 4节点 转换为 由 3个 2节点 组成的一棵平衡的树，如图所示，可以将其理解为二分搜索树与 2-3树，只不过每个节点都是 2节点，同时这棵树保持着绝对的平衡![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190223154124825.png)

5. 在树中再添加新元素 18，根节点是37 ，要将 18 添加到其左子树12 中 ，18 > 12 故将其添加到 12 的右子树中去 ，此时 12 的右子树 已经为空【==新节点永远不会去 空 的位置，只会和最后找到的叶子节点做融合==】,这棵树保持着绝对的平衡![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208222506095.png)
...
6. 在树中再添加新元素 6，根节点是37 ，要将 18 添加到其左子树(包含 12 18 的3节点) 中 ，6 < 12 故将其添加到 3节点 的左子树中去 ，此时 3节点 的左子树 为空【新节点永远不会去 空 的位置，只会和最后找到的叶子节点做融合】，故先融合为 4节点
   ...
   ![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208222513163.png)

7. 将 4节点 拆解，变为 包含 3个 2节点 的子树

   ![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208222521733.png)

   

   如果拆分为上图所示，此时的 2-3 树不是 **绝对 平衡的树**，对 2-3树 来说，如果其叶子节点本身已经是一个 3节点 了，添加一个节点变为 4节点 ，变为如图所示，则 12 需要与其父节点 37 进行融合，37 是 2节点，12 和 37 可以直接融合为 3节点，此时该树仍然 绝对平衡。![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208222806549.png)

8.在树中再添加新元素 11，根节点是 12 37 的3节点，要将 11 添加到其左子树6中 ，**6 < 11 故将其添加到 6 的右子树中去 ，此时 6 的右子树 为空【新节点永远不会去 空 的位置，只会和最后找到的叶子节点做融合】，故先融合为 3节点**![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208222820275.png)

9.在树中再添加新元素 5，根节点是 12 37 的3节点，要将 5 添加到其左子树 6 11 的3节点 中 ，5 < 6 故将其添加到 6 11 的3节点左子树中去 ，此时 6 11 的3节点 的左子树 为空【新节点永远不会去 空 的位置，只会和最后找到的叶子节点做融合】，故先融合为 4节点。![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208222838062.png)

将 4节点 拆解，变为 包含 3个 2节点 的子树

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208222842608.png)
...
**![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208222848733.png)**

将 4节点 拆解，变为 包含 3个 2节点 的子树，此时，树仍然 绝对平衡并保持着 2-3树的性质

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208222854649.png)

### 总结：![image-20190208222929621](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190208222929621.png)

![image-20190208222950479](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190208222950479.png)

## 3.红黑树与2-3树的等价性

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223001326.png)

表示 b 和 c 是并列关系(一起存放在 3节点 中)，则将其 连线 设置为 红色； 将其还原为 二分搜索树中的样子

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223001334.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223013769.png)

![image-20190208223030543](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190208223030543.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223057766.png)

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223112200.png)
...
![image-20190208223150628](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190208223150628.png)

**解决方法：左旋转，上图 经过 左旋转 变为 下图**

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223211817.png)

左旋转过程**（T1<37<T2<42<T3）**：

1.假设根节点为 node，node 的右孩子为 x

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223219099.png)

2.node.right = x.left，让 node 的右孩子 为 x 的左子树, 仍然保持二分搜索树性质

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223219670.png)

3.x.right = node, x 的左子树连接上 node ,完成左旋转，37 从原来 42 的父亲 变为 42 的右孩子，相当于逆时针旋转，在 37 来看是左旋转

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223227644.png)

**4.对于红黑树来说，需要维护颜色信息**

x.color = node.color **,新的根节点是 x节点，x节点的颜色要和以前的节点 node 的颜色是一样的**

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223235428.png)

node 变为 x 的左孩子，**对应到 2-3 树中，还是临时的 4节点，要让 node 的颜色变为 红色，node.color = RED；表示它和它的父亲节点 42 是融合在一起的 ；**这样就完成了整个左旋转过程

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223242242.png)

## 5.颜色翻转和右旋转

### 红黑树添加新元素

![image-20190208223356939](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190208223356939.png)

![image-20190208223415267](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190208223415267.png)

![image-20190208223428968](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190208223428968.png)

在红黑树中，需要用到 右旋转

1.假设根节点为 node，node 的左孩子为 x ，

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223511941.png)

2.node.left = T1，让 node 的左子树 为 左孩子的右子树, 仍然保持二分搜索树性质

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223519262.png)

3.x.right = node ,完成右旋转，42 从原来 37的父亲 变为 37的右孩子，相当于顺时针旋转，在 37 来看是右旋转

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223519254.png)

4.对于红黑树来说，需要维护颜色信息

**x.color = node.color ,新的根节点是 x节点，x节点的颜色要和以前的节点 node 的颜色是一样的**

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223536519.png)

node 变为 x 的右孩子，对应到 2-3树中，还是临时的 4节点，要让 node 的颜色变为 红色，node.color = RED；表示它和它的父亲节点 42 是融合在一起的 ；这样就完成了整个右旋转过程

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223542653.png)

### 总结：

![image-20190208223620296](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190208223620296.png)



![image-20190208223636429](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190208223636429.png)

![image-20190208223653537](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190208223653537.png)

![image-20190208223711739](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190208223711739.png)

红黑树性能总结：

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190208223742054.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154100536.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154210481.png)

大整数：

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154231130.png)

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154231853.png)

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154231925.png)
...
在计算机中都是 32位 或 64位 的二进制表示，只不过计算机解析成了浮点数
 ...
 ![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154252054.png)
...
### ![image-20190225154304189](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190225154304189.png)

### 4.复合类型

方法：转成 整型 处理

![image-20190225154331024](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190225154331024.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154416601.png)

2.假如计算后 k1 的索引对应是 4 的话，在哈希表索引为 4 的位置存储 k1

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154425015.png)

3.再加入元素 k2 ，则用相同的方法计算出索引值 为 1，插入到哈希表中

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154425012.png)

4.再加入元素 k3 ，则用相同的方法计算出索引值 为 1，产生哈希冲突，但仍然将其插入到哈希表中，**将其作为 链表 即可**

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154448663.png)

链地址法：对整个哈希表，开辟 m 个空间，对于每一个空间，由于有哈希冲突的存在，其本质上都是存储 一个链表（==查找表==），**查找表的底层实现不一定是链表，也可以使用树结构**，如图![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154455846.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154527402.png)
...
![image-20190225154629490](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190225154629490.png)

知哈希表均摊时间复杂度为：O(1)

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154637837.png)

代码中的Bug: Comparable(可比较性矛盾)，TreeMap的key有可比性

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154647417.png)
...
## ![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154702349.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154724019.png)

开放地址法和上述方法相反，**对于哈希表中的每一个地址，所有哈希值的元素都有机会进入**

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154736965.png)

每一个地址就是直接存元素，**11 和 31 产生哈希冲突，就从索引为 1 的地方向下找，空的地方是索引为 2 的地方，故将 31 放在 2 中；**

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225214106479.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/70-20190225154757164.png)

### 总结：

![image-20190225154813506](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190225154813506.png)
