...
Redis的集合可以对于不同的集合进行操作，比如求出两个或者以上集合的交集、 差集和并集等。集合命令如下表：![image-20181216165008020](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20181216165008020-4950208.png)
