![image-20190416164514391](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190416164514391.png)

![image-20190416164642115](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190416164642115.png)

# 一、IoC

![image-20190416172122134](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190416172122134.png)
...
![Spring IoC](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/02.jpg)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/4236553-1e6ca4c8a58c9e8e.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/4236553-db065eecf16176c3.png)
...
![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/4236553-da9a2f92e4dfa9db.png)
...
![image-20190331211349307](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190331211349307.png)

![æµç¨å¾](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/08.png)
...
![循环依赖](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/20170912082357749.jpeg)
...
2. field 属性的循环依赖。
   ...
   2. scope为prototype的时候
      ...
      ![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/auto-orient.png)
...
- 这个方法在 `doGetBean(...)` 方法中，**处理不同 scope 时，如果是 singleton，则调用 `getSingleton(...)` 方法，如下图所示：**
  ...
  ![getSingleton](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/20170912091609918.jpeg)
...
>
> ![处理依赖循环](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/01.png)

![img](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/auto-orient-20190402104237476.png)

参照：<https://www.jianshu.com/p/8bb67ca11831>

# 三、注解

![image-20190416165220081](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190416165220081.png)
...
![image-20190417163118123](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190417163118123.png)
...
![流程图](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/04.jpg)
...
![事务的特性](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/06-20190402181033382.png)
...
![image-20190402182417942](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/image-20190402182417942.png)
...
![PlatformTransactionManager根据不同持久层框架所对应的接口实现](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/1637b21877cf626d.png)
...
④ 最后，不同的数据持久层框架，会有其对应的 PlatformTransactionManager 实现类，如下图所示：![事务的特性](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/07.png)
...
​	事务属性可以理解成事务的一些基本配置，描述了事务策略如何应用到方法上。事务属性包含了5个方面。 ![äºå¡å±æ§](https://learningpics.oss-cn-shenzhen.aliyuncs.com/images/1637b43a47916b2d.png)
...
>
> **NESTED**，在原事务内启动⼀个内嵌事务，两个事务有关联，外部事务回滚，内嵌事务也会回滚
